...
define config.name = _("ypoK GeoGpaFii")
...
define gui.about = _p("""Игра сделана разработчиками Татёмкой и Тадимкой
""")
...
define build.name = "ypoKGeoGpaFii"
...
define config.save_directory = "ypoKGeoGpaFii-1774879694"
